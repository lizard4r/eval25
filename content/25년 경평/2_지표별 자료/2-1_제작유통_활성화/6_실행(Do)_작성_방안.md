---
{"publish":true,"permalink":"/경영평가/주요사업1/실행","title":"6_실행(Do)","created":"2025-12-09","modified":"2025-12-13T23:48:34.850+09:00","tags":["#경영평가","#주요사업","#제작유통활성화","#비계량","#작성방안"],"cssclasses":""}
---
...
> 
> **시사점**: 기획개발 지원 확대로 콘텐츠 다양성 확보 및 신진인력 진입 기회 제공 필요
...
> 
> **시사점**: 민간 투자 위축 상황에서 중예산 제작지원으로 민간투자 촉진 필요
...
> [!quote] 📊 연구보고서 근거: 한국영화 투자 활성화를 위한 정책금융 활용 방안 연구 (KOFIC 연구 2025-06)
> **모태펀드 영화계정 현황** (2011-2024)
> - 총 출자액: **2,000억 원**, 총 투자액: **3,820억 원**
> - 영화계정 투자영화: **271편** (상업영화 643편 중 **42.1%**)
> - 2024년 개봉영화 총제작비 중 영화계정 투자액 비중: **20.5%**까지 상승
> 
> **영화계정의 역할**
> - 코로나19 이후 민간 투자 위축 상황에서 **정책금융의 산업 지지대 역할** 확대
> - 업계 77.6%가 '정책금융 투자 펀드 확대' 필요 응답
> 
...
> - 성수기/비수기 경계 약화: **콘텐츠 경쟁력이 시장 규모 좌우**
> - 팬덤 기반 콘텐츠 성공: 애니메이션, 공연실황, 다큐멘터리
> 
> **시사점**: 콘텐츠 경쟁력 확보가 핵심 → 기획개발·제작·투자 전 단계 공적 지원 확대 필요
...
> 
> **시사점**: 기술중심 AI 영화 관행 극복, **스토리텔링 기반 AI 교육체계** 구축 필요
...
> 
> **경력관리 현황**
> - 경력관리 이유: 보수수준 향상 57.7%, 업무능력 향상 33.1%
> - 6개월 이상 경력단절 경험: 26.6%
> 
> **시사점**: 현장영화인 교육 수요 증가, 지속적 교육 투자로 역량 강화 필요
...
>
> **조직인력 효율성 작성법**:
> - **기존 문제**: 무엇이 비효율적이었는지 (프로세스, 체계, 운영방식)
> - **개선 노력**: 어떻게 개선했는지 (신규 도입, 통폐합, 체계화)
> - **성과**: 어떤 효과가 있었는지 (수치로 제시)
>
> **예시**:
> - 기존: 제작지원 연 1회 공모
> - 노력: 연 **2회** 공모 확대
> - 성과: 창작자 사업 신청 제약 해소, 참여도 제고
...
> - 가능하면 **절감률(%)** 또는 **절감액** 명시
> - 예산 집행의 **투명성, 효율성** 강화 사례 포함
>
> **좋은 예시**:
> - "수익 발생 시 지원금 일부 회수 조항 도입으로 **재원 환원 구조 마련**"
> - "투자조합 조건 개선으로 투자금액 **27% 증가**"

| 구분               | 노력                                                                                    | 성과                                                     |
| ---------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| **기획개발지원 재원 환원** | **기존**: 전작 흥행 기반 일괄 지급되는 차기작 기획개발지원<br>**개선**: 수익 발생 시 지원금 일부 회수 조항 도입 ('26년 사업요강 반영) | • 지원작 수익 발생 시 보조금 환원으로 재원 낭비 최소화<br>• 영화기금 재원 환원 구조 마련 |
